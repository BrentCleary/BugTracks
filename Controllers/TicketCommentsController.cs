...
namespace BugTracks.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.TicketsComments.Include(t => t.Ticket).Include(t => t.User);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ticketComment = await _context.TicketsComments
                .Include(t => t.Ticket)
                .Include(t => t.User)
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ticketComment = await _context.TicketsComments.FindAsync(id);
            if (ticketComment == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (ticketComment != null)
            {
                _context.TicketsComments.Remove(ticketComment);
            }
        ...
        {
            return _context.TicketsComments.Any(e => e.Id == id);
        }
    }
}
