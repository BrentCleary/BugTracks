...
namespace BugTracks.Controllers
{
    public class TicketsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TicketStatusId"] = new SelectList(_context.TicketsStatuses, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Created,Updated,Archived,ProjectId,TicketTypeId,TicketPriorityId,TicketStatusId,OwnerUserId,DeveloperUserId")] Ticket ticket)
        {
            ...
            ViewData["TicketStatusId"] = new SelectList(_context.TicketsStatuses, "Id", "Id", ticket.TicketStatusId);
