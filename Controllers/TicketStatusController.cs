...
namespace BugTracks.Controllers
{
    public class TicketStatusController : Controller
    {
        ...
        {
            return View(await _context.TicketsStatuses.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var ticketStatus = await _context.TicketsStatuses
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var ticketStatus = await _context.TicketsStatuses.FindAsync(id);
            if (ticketStatus == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (ticketStatus != null)
            {
                _context.TicketsStatuses.Remove(ticketStatus);
            }
        ...
        {
            return _context.TicketsStatuses.Any(e => e.Id == id);
        }
    }
}
